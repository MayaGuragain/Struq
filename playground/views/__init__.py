...
from playground.views.seg_views import *
from playground.views.fenwicktree_views import *
from playground.views.trie_views import *
...
from playground.views.disjointset_views import *
from playground.views.pq_views import *
from playground.views.cb_views import *
from playground.views.skiplist_views import *
from playground.views.rope_views import *
from playground.views.ht_views import *
from playground.views.bitset_views import *
